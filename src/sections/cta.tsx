...
const settings = {
  title: 'Siap Nonton Theater JKT48?',
  description: 'Bergabung bersama ribuan wota yang sudah menikmati live stream theater JKT48 bersama Team48Live. Harga hemat, akses mudah, langsung dari genggamanmu.',
  CTA: {
